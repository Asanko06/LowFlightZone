...
|Рейс	Конкретный        | авиаперелёт с номером, статусом, временем вылета/прилёта и аэропортами отправления и прибытия.|
...
|Актер	       |Описание|
|:-------------|:-------------------------------------------------|
|Гость	       |Неаутентифицированный пользователь. Может выполнять поиск рейсов и просматривать их статус.|
